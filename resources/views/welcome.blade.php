...
@section('content')
    ...
    <div class="formulario">
        ...
        <div class="formulario-contenedor">
            <form action="base-datos.php" method="GET">
                ...
                <div class="formulario-grupo">
                    ...
                    <div class="formulario-input">
                        <input type="text" style= "width: 100%; height: 2rem;" name="Hola" id="" required >
                    </div>
                </div>
                ...
                <div class="formulario-grupo">
                    ...
                    <div class="formulario-input">
                        <textarea name="" id="" cols="30" rows="10" style="width: 100%;" required></textarea>
                    </div>
                </div>
