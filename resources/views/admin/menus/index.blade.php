            ...
            @foreach($menus as $menu_element)
                <div class="table-row swipe-element">
                    ...
                    <div class="table-icons-container swipe-back">
                        <div class="table-icons boton-editar right-swipe" data-url="{{route('menus_edit', ['menu' => $menu_element->id])}}">
                            <svg viewBox="0 0 24 24">
                                <path d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z" />
                            </svg>
                        </div> 
                        
                        <div class="table-icons borrar-dato left-swipe" data-url="{{route('menus_destroy', ['menu' => $menu_element->id])}}">
                            <svg viewBox="0 0 24 24">
...
@section('form')
    ...
    @isset($menu)
        ...
        <div class="formulario-contenedor">
            ...
            <form class="admin-formulario" id="menus-form" action="{{route("menus_store")}}" autocomplete="off">
