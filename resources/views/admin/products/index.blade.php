    ...
    <div class="tabla-contenedor">
        @isset($faqs)
            ...
            <div id="table-container" class="table-elements">
                @foreach ($prodcut as $product_element)
                    <div class="swipe-element">
                        <div class="swipe-front promote-layer">
                            <div class="table-content">
                                <p><span> Nombre:</span> {{$product_element->name}} </p>
                                <p>{{$faq_element->description}}</p>
                            </div>
                        </div>

                        <div class="swipe-back table-icons" >
                            <div class="boton-editar right-swipe" data-url="{{route("products_edit", ['product' => $faq_element->id])}}" > 
                            ...
                            <div class="boton-borrar borrar-dato left-swipe" data-url="{{route("products_destroy", ['faq' => $faq_element->id])}}"> 
                                <svg viewBox="0 0 24 24">
